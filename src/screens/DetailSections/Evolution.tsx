...
export const Evolution = ({
    ...
    <Animated.View style={{opacity}}>
      <View style={styles.containerEvolutionRow}>
        <View style={styles.containerPictureText}>
          <FadeInImage
            uri={evolutionPokemon[0]?.picture}
            style={styles.picture}
          />
        ...
        <View style={styles.containerPictureText}>
          <FadeInImage
            uri={evolutionPokemon[1]?.picture}
            style={styles.picture}
          />
      ...
      <View style={{...styles.containerEvolutionRow, marginTop: 30}}>
        ...
        <View style={styles.containerPictureText}>
          <FadeInImage
            uri={evolutionPokemon[2]?.picture}
            style={styles.picture}
          />
    ...
    return (
      <Animated.View style={{opacity}}>
        <View style={styles.containerEvolutionRow}>
          <View style={styles.containerPictureText}>
            <FadeInImage
              uri={pokemonsToRender[0]?.picture}
          ...
          <View style={styles.containerPictureText}>
            <FadeInImage
              uri={pokemonsToRender[1]?.picture}
              style={{width: 150, height: 150}}
            />
  ...
  const renderOneEvolution = () => {
    ...
    return (
      <Animated.View style={{opacity}}>
        <View
          style={{...styles.containerEvolutionRow, justifyContent: 'center'}}>
          <View style={styles.containerPictureText}>
            <FadeInImage
              uri={pokemonsToRender[0]?.picture}
              style={{width: 150, height: 150}}
    ...
    <View
      ...
      <View style={{width: width * 0.8}}>
        {isLoading
          ? renderSpinner()
          : evolutionEvee.length > 0
          ? renderEveeEvolutions()
          : pokemonsToRender.length === 3
          ? renderThreeEvolutions()
          : pokemonsToRender.length === 2
          ? renderTwoEvolutions()
          : renderOneEvolution()}
      </View>
    </View>
